				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to Editor Beta! 🎉" />
							<Description description="You're among the first to try Editor - the fully open source CapCut alternative." />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title={getStepTitle()} />
							<Description
								description={`Join our [Discord](${SOCIAL_LINKS.discord}), chat with cool people and share feedback to help make Editor the best editor ever.`}
							/>
						</div>
